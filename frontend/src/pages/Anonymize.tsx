        ...
        <div className="space-y-8">
            ...
            <div>
                ...
                <p className="text-muted-foreground">
                    Upload medical documents to automatically identify and
                    redact sensitive patient information.
                </p>
            </div>
            ...
            <div className="grid gap-6 md:grid-cols-2">
                ...
                <div className="rounded-lg border border-blue-500/20 bg-blue-500/5 p-6">
                    ...
                    <p className="text-muted-foreground text-sm">
                        All documents are encrypted in transit and at rest. Our
                        AI processes data in compliance with HIPAA and GDPR
                        regulations. Original documents are securely deleted
                        after anonymization.
                    </p>
                </div>
            </div>
